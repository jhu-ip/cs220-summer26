...
Next go back to the enclosing directory (using `cd ..` command) and rename your private repository from *YEAR-TERM-student-JHED* to *my220repo* by typing `mv YEAR-TERM-student-JHED my220repo`, where YEAR and TERM match the current semester and JHED is your own unique JHED ID. This will make it easier to navigate to your private repo directory and makes your linux commands shorter. (Note that the repo name on github will not change.)
